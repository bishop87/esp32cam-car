...
<html>
  ...
  <body>
    ...
    <img src="" id="photo" >
    <table>
      <tr><td align="center"><label for="bpwm">PWM</label><br><input type="number" id="bpwm" name="bpwm" value="800" min="0" max="1023"></td><td align="center"><button class="button" onmousedown="toggleCheckbox('forward');" ontouchstart="toggleCheckbox('forward');" onmouseup="toggleCheckbox('stop');" ontouchend="toggleCheckbox('stop');">AVANTI</button></td></tr>
